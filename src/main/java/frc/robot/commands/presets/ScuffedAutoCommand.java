...
public class ScuffedAutoCommand extends SequentialCommandGroup{  
    private double speed = 0;
    private Rotation2d angle =Rotation2d.fromDegrees(30);
    public ScuffedAutoCommand(Swerve swerve, Launcher launcher, Feed feed, Intake intake, Arm arm, double waitTime){
        speed = Constants.EndEffectorConstants.speakerLaunchSpeed;
        angle = Constants.OperatorConstants.speakerPosition;
        
        addRequirements(swerve, launcher, arm, feed, intake);
