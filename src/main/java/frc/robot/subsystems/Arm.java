...
//         armController1.setP(0.0002);
//         armController1.setI(0);
//         armController1.setD(2.0);
//         armController1.setFF(0.3);
//         armController2.setP(0.0002);
//         armController2.setI(0);
//         armController2.setD(2.0);
//         armController1.setFF(0.3);
//     }
...
//         }else{
//             this.armController1.setReference(speed*3, ControlType.kVelocity);
//             this.armController2.setReference(speed*3, ControlType.kVelocity);
//         }        
//     }
// }
    ...
    // }
     ...
     public void setSpeed(double speed) {
        ...
        if(speed<0){
            ...
            raiseMotor1.set(speed*0.25);
            raiseMotor2.set(speed*0.25);
        }
